...
USER_SERVER_ENDPOINT = os.getenv('USER_SERVER_ENDPOINT')
if USER_SERVER_ENDPOINT is None:
...
BASE_INPUT_DB_DIRECTORY = os.getenv("BASE_INPUT_DB_DIRECTORY")
if BASE_INPUT_DB_DIRECTORY is None:
    BASE_INPUT_DB_DIRECTORY = os.getenv("HOME") + '/faceRecognition/data_input'
...
if BLACKLIST_DB_NAME is None:
    ...
    log_warning('BLACKLIST_DB_NAME not defined as global variable, using default value: '+ BLACKLIST_DB_NAME)
